...
exports.extractDates = void 0;
const extractDates = (taxonomies, deleteDates = true) => {
    const r = {
        taxonomies: [],
        dates: {},
    };
    ...
    taxonomies.forEach((t, ti) => {
        ...
        if (potentialDEDate) {
            ...
            if (potentialDEDate[0] === t.value.trim() ||
        ...
        if (!date) {
            ...
            if (potentialENDate) {
                ...
                if (potentialENDate[0] === t.value.trim() ||
